...
<button class="btnwork" id="fixedbutton"><a href="add-admin.php" style="text-decoration:none;color:white;">Add Question</a></button>
...
function loadTable()
	...
	$.ajax({
		url:"loadrecent50-ajax-admin.php",
		type : "POST",
...
$(document).on("click",".row-delete", function(){
	...
	$.ajax({
		...
		success : function(data){
			if(data==1)
			{
			$(".content-head-item").html("Deleted successfully");
			loadTable();
		...
		if(data==2)
			{
				$(".content-head-item").html("Failed to Delete this question");
			}
